...
The fundamental challenge in causal inference is the unobservability of counterfactual outcomes. The synthetic control method addressed this by constructing a weighted combination of control assets that tracked the target coin's pre-pump behavior, then using this synthetic control as the counterfactual benchmark. This appendix detailed the technical evaluation of this theoretical framework.
...
\caption{Distribution of $R^2$ scores across different market caps. The scores are consistently near zero, showing that synthetic controls cannot accurately track micro-cap assets.}

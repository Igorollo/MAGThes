...
\label{eq:log-return}
\end{equation}
Here, $P_{i,t}$ is the price for event $i$ at minute $t$. Below, $Y_i$ refers to this realized 10-minute outcome.
